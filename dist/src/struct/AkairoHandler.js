...
class AkairoHandler extends events_1.default {
    ...
    constructor(client, options) {
        const { directory, classToHandle = AkairoModule_js_1.default, extensions = ['.js', '.json', '.ts'], automateCategories = false, loadFilter = () => true, } = options !== null && options !== void 0 ? options : {};
        super();
        this.client = client;
    ...
    load(thing, isReload = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let mod = isClass
                ...
                }.call(this, yield eval(`import(${JSON.stringify(url_1.default.pathToFileURL(thing).toString())})`));
    ...
    reload(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newMod = yield this.load(filepath, true);
            return newMod;
        });
    }
    /**
